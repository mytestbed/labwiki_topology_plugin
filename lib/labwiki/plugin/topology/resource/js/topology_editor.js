    ...
    var topology_editor = function(container, opts) {
      ...
      var parameters = {
        ...
        interface: {
          ...
          netmask: { label: 'Netmask', type: 'text' },
        },
        link: {
          capacity: { label: 'Capacity', type: 'int' },
          delay: { label: 'Delay', type: 'int' },
        }
      };

      var graph = {nodes: [{_id:"8ec2c565-c3b5-452c-be2b-d58d18fe590b", _type:"node", _x:269, _y:218},
      ...
      var graph_editor = GraphEditor(graph, container.find('.canvas'), {
                            editable: editable,
      ...
      graph_editor.on_selected(function(entity) {
      ...
      graph_editor.before_popup(function(type, entity) {
        var name = entity.name;
        if (!name) {
          if (entity.uuid) {
            name = entity.uuid.slice(28);
          } else {
            name = 'Unknown';
          }
        }
        var t = "&nbsp;<b>" + (entity.type || type) + ":</b> " + name + "";
        return t;
      });
