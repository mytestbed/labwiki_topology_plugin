...
define(['vendor/d3/d3'], function () { // 'd3' will be in the global namespace
  ...
  var graph_editor = function(container, opts) {
    ...
    function restart_links() {
      var p = path_g.selectAll('.link').data(links, function(l) { return l.uuid; });
      p.enter().append('line')
    ...
    function restart_elements() {
      var c = circle_g.selectAll('.element').data(nodes, function(d) { return d.uuid; });
      ...
      g.append('svg:circle')
          ...
          .on('mouseup', function(d) {
              ...
              if(link) {
                  ...
                  link = {uuid: create_uuid(), source: source, target: target, left: false, right: false};
                  link[direction] = true;
                  links.push(link);
              }
      ...
      // UPdate for 'tick'
      circle = circle_g.selectAll('.element');
    ...
    container.each(function() {
      ...
      circle_g = svg.append('svg:g').attr("class", "elements");
